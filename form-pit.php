    		 		...
    		 		<div class="list-form">
    		 			<div class="cb-form-group">
                            ...
                            <div class="cb-input cb-input_light wow fadeInUp wHighlight" data-wow-delay=".25s">
                                ...
                                <div class="required" key="yourNameRq">Your name is required</div>
                            </div>
                            <div class="cb-input cb-input_light wow fadeInUp wHighlight" data-wow-delay=".25s">
                                <div class="cb-input_light-box"> 
                                ...
                                <div class="cb-input_light-message"></div>
                                <div class="required" key="yearOfBirthRq">Year of Birth is required</div>
                            </div>
                            <div class="cb-input cb-input_light wow fadeInUp wHighlight" data-wow-delay=".25s">
                                <div class="cb-input_light-box">
                            ...
                            <div class="cb-input cb-input_light wow fadeInUp wHighlight" data-wow-delay=".25s">
                                <div class="cb-input_light-box">
                                    <input type="text" class="lang" data-translate="designCoursesEach" id="designCoursesEach" placeholder="Design course has participated"/>
                                    <div class="cb-input_light-line"></div>
                                </div>
                                <div class="cb-input_light-message"></div>
                            </div>
    		 			...
    		 			<div class="cb-form-group">
                            ...
                            <div class="cb-input cb-input_light wow fadeInUp wHighlight" data-wow-delay=".25s">
                                <div class="cb-input_light-box">
                                    <textarea name="" id="" cols="30" rows="10" class="lang" id="weAreReadyToListen" data-translate="weAreReadyToListen" placeholder="We are ready to listen to any questions you may have ..."></textarea>
                                    <div class="cb-input_light-line"></div>
                                </div>
                                <div class="cb-input_light-message"></div>
                            </div>
                            ...
                            <div class="cb-input cb-input_light wow fadeInUp wHighlight" data-wow-delay=".25s">
                                <div class="cb-input_light-box">
                                    <button class="btn-form">
                                        ...
                                        <span class="lang" id="submitYourProfile" key="submitYourProfile">Submit your profile</span>
                                    </button>
                                </div>
                            </div>
                        </div>
