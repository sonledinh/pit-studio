	 	...
	 	<div class="container">
	 		<div class="max-740">
	 			<div class="title-main wow fadeInUp wHighlight" data-wow-delay=".25s">
		 			<h1>Hi, please <br> introduce yourself a bit</h1>
		 		</div>
                <form action="result.php" method="post">
    		 		<div class="list-form">
    		 			<div class="cb-form-group">
    		 				<div class="title-form wow fadeInUp wHighlight" data-wow-delay=".25s"><p><img src="images/t-form-1.svg" class="img-fluid" alt="">Personal information</p></div>
    		 			...
    		 			<div class="cb-form-group">
    		 				<div class="title-form wow fadeInUp wHighlight" data-wow-delay=".25s"><p><img src="images/t-form-2.svg" class="img-fluid" alt="">Contact information</p></div>
                            <div class="cb-input cb-input_light wow fadeInUp wHighlight" data-wow-delay=".25s">
                                <div class="cb-input_light-box">
    		 			...
    		 			<div class="cb-form-group">
    		 				<div class="title-form wow fadeInUp wHighlight" data-wow-delay=".25s"><p><img src="images/t-form-3.svg" class="img-fluid" alt="">Your creation</p> <span>Summarize any of your best design experiences here</span></div>
                            <div class="cb-input cb-input_light wow fadeInUp wHighlight" data-wow-delay=".25s">
                                <div class="cb-input_light-box">
    		 			...
    		 			<div class="cb-form-group">
    		 				<div class="title-form wow fadeInUp wHighlight" data-wow-delay=".25s"><p><img src="images/t-form-4.svg" class="img-fluid" alt="">Do you have a message to Pit?</p></span></div>
                            <div class="cb-input cb-input_light wow fadeInUp wHighlight" data-wow-delay=".25s">
                                <div class="cb-input_light-box">
