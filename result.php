    ...
    <section class="result">
        <div class="container text-center">
            <div class="content-result">
                ...
                <div class="desc">
                    <p class=" wow fadeInUp wHighlight" data-wow-delay=".45s">Thank you for your registration, we will <br> get back to you as soon as possible</p>
                    <div class="btn-apply wow fadeInUp wHighlight" data-wow-delay=".45s"><a href="https://dribbble.com/PitStudio">
