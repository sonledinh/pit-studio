    ...
    <section class="result">
        <div class="container text-center">
            <div class="content-result">
                <div class="avarta  wow fadeInUp wHighlight" data-wow-delay=".45s"><img src="images/result.png" class="img-fluid" alt=""></div>
                <div class="desc">
                    <p class=" wow fadeInUp wHighlight" data-wow-delay=".45s"><span class="lang" key="thankYouFor">Thank you for your registration, we will</span> <br> <span class="lang" key="getBackTo">get back to you as soon as possible</span></p>
                    <div class="btn-apply wow fadeInUp wHighlight" data-wow-delay=".45s"><a target="_blank" href="https://dribbble.com/PitStudio">
                        ...
                        <span class="lang" key="productBy">See our work</span>
                    </a></div>
                </div>
            </div>
        </div>
